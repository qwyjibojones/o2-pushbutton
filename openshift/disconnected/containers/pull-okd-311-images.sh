...
openshift/origin-metrics-server:v3.11.0 \
openshift/origin-metrics-heapster:v3.11 \
openshift/origin-metrics-heapster:v3.11.0 \
openshift/origin-metrics-cassandra:v3.11 \
openshift/origin-metrics-cassandra:v3.11.0 \
openshift/origin-metrics-hawkular-metrics:v3.11 \
openshift/origin-metrics-hawkular-metrics:v3.11.0 \
...
openshift/origin-service-catalog:v3.11.0 \
openshift/origin-template-service-broker:v3.11 \
openshift/origin-template-service-broker:v3.11.0 \
